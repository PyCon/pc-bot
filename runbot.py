...
if __name__ == '__main__':
    ...
    p.add_argument('--irc-channel', default='#pycon-pc')
    p.add_argument('--irc-nickname', default='pycon_bot')
    ...
    # Run ze bot!
    run_bot(irc_server=args.irc_server, irc_port=args.irc_port,
            irc_channel=args.irc_channel, bot_name=args.irc_nickname,
            http_port=args.http_port, logfile=sys.stderr)
